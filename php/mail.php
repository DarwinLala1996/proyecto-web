<?php
    ...
    $subject ='Gracias por tu compra en xstore.com';
    $header='MIME-Version 1.0'."\r\n";
    $header.='From: xstore@midominio.com'."\r\n";
    ...
    $message.='<a href="http://localhost/proyecto-web/verpedido.php?id_venta='.$id_venta.'" style="background-color: brown;color:white;padding: 10px;text-decoration: none;">
